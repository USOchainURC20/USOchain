...
describe("URC20 Token", function () {
  ...
  it("should assign total supply to the owner", async function () {
    ...
    // Define the expected total supply (using ethers.parseUnits with 6 decimals)
    const totalSupply = ethers.parseUnits("5710000000000000000000000000000000000000000000000000000", 6);
